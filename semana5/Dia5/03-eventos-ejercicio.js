...
// Waves.attach('.botonComprar',[Estilos adicionales]);
Waves.attach('.botonComprar');
Waves.attach('.contenedor');
// el init, sólo se usa al final de tooooooodas las configuraciones
Waves.init();